...
import GitHubStarsAnimation from "../github-stars-animation";
          ...
          <div className="relative">
              ...
              <div>
                ...
                >
                  <GradientWaveText
                    ...
                    className="mt-4 text-balance text-4xl font-semibold sm:text-5xl md:text-6xl lg:mt-8"
                  >
                    Open-source, self-hostable alternative to Cloudinary
                  </GradientWaveText>
                  {/* <p className="mt-8 max-w-2xl text-pretty text-lg">
                    Store your medias in an environment you trust. Fast, cheap,
                    and open.
                  </p> */}
                  <ul className="flex flex-col sm:flex-row gap-4 mt-6">
            ...
            >
              <div className="relative mt-12 overflow-hidden">
                ...
                />
                <div className="inset-shadow-2xs ring-background inset-shadow-[color:oklch(var(--foreground)/0.2)] bg-background relative w-full overflow-hidden rounded-2xl border shadow-lg shadow-[color:oklch(var(--foreground)/0.15)] ring-1">
                  <img
